...
Note: AI -- mainly ChatGPT 5.5 plus but also other models -- have been and will continue to be indespensible in creating and maintaining the userChrome.css and userContent.css files (I'm not going to spend a year or more of my life painstakingly manually writing fragile .css code for Firefox); if, for whatever reason, you have a principle against using AI, this is your warning.
